...
NO_PROXY="localhost,127.0.0.1,docker-registry.somecorporation.com,registry-cn-wulanchabu-vpc.ack.aliyuncs.com,dockerauth-vpc.cn-wulanchabu.aliyuncs.com"
